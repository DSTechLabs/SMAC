...
void onCommandReceived (const uint8_t *relayerMAC, const uint8_t *inCommandString, int commandlength);
...
void onCommandReceived (const uint8_t *relayerMAC, const uint8_t *commandString, int commandLength)
{
  if (Debugging)
  {
