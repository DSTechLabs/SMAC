//=============================================================================
//
//     FILE : Dev_StepperMotor_2Phase.h
//
...
#ifndef DEV_STEPPERMOTOR_2PHASE_H
#define DEV_STEPPERMOTOR_2PHASE_H
...
//=========================================================
//  class Dev_StepperMotor_2Phase
//=========================================================

class Dev_StepperMotor_2Phase : public Device
{
  private:
  ...
  public:
    Dev_StepperMotor_2Phase (const char *inName, int enablePin=2, int directionPin=3, int stepPin=4, int llSwitchPin=-1, int ulSwitchPin=-1);
