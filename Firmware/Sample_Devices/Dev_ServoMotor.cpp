...
//  Constructor
//----------------------------------------------------------
Dev_ServoMotor::Dev_ServoMotor (Adafruit_PWMServoDriver *inServoDriver,
                                int inChannelNum,
...
void Dev_ServoMotor::startRotation ()
{
  // Set Direction
...
int Dev_ServoMotor::angle2PW (int angle)
{
...
void Dev_ServoMotor::RotateAbsolute (int targetAngle, MotorSpeed inSpeed)
{
...
void Dev_ServoMotor::RotateRelative (int angle, MotorSpeed inSpeed)
{
...
void Dev_ServoMotor::RotateHome ()
{
...
void Dev_ServoMotor::SetPulseWidth (int pulseWidth)
{
...
MotorState Dev_ServoMotor::GetState ()
{
...
long Dev_ServoMotor::GetAbsolutePosition ()
{
...
long Dev_ServoMotor::GetRelativePosition ()
{
...
const char * Dev_ServoMotor::GetVersion ()
{
  return version;
}
...
const char * Dev_ServoMotor::ExecuteCommand (const char *packet)
{
  char  command[3];
  int   targetOrAngle;
