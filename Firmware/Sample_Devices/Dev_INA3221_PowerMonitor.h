/**
 * @file Dev_INA3221_PowerMonitor.h   for 3 channel PWR monitor breakout
 * @author Doug Fajardo
...
class Dev_INA3221_PowerMonitor : public Adafruit_INA3221, public Device
{
    private:
        int i2cAddr;

    public:
        Dev_INA3221_PowerMonitor(const char *inName);
        ~Dev_INA3221_PowerMonitor();
